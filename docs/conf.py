...
project = 'Repo4Cat'
copyright = '2024, Repo4Cat contributors'
author = 'Volodymyr Kushnarenko, David Linke, and Repo4Cat contributors'
...
html_theme_options = {
    ...
    "light_css_variables": {
        "color-brand-primary": "#016992",  # dark blue of "Cat" in light xxx4Cat logo
        "color-brand-content": "#016992",
        "color-announcement-background": "#91c63f",  # green of "4" in light xxx4Cat logo
    ...
    "source_repository": "https://github.com/nfdi4cat/repo4cat",
    "source_branch": "main",
    "source_directory": "docs/",
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/nfdi4cat/repo4cat",
            "html": """
    ...
    "announcement": "<strong>News 2024-12-18</strong>: Created Sphinx documentation skleleton for Repo4Cat.",
}
